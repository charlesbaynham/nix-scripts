...
rec {
  ...
  misoc = python3Packages.buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      owner = "m-labs";
      repo = "misoc";
      rev = "55221f7eb621eb4ee5ae94c7cd15e2bcaa3b5082";
      sha256 = "19ai26zdvds7xyhifhg2n76yph3nnd7lb0yc9a1qknv293k7f4ds";
  ...
  migen = python3Packages.buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      owner = "m-labs";
      repo = "migen";
      rev = "ef7dab24ff0446db5904d11faefc46dbff0cf2b9";
      sha256 = "0i7xmg7mqijhib2bxh34cpslkg920a0zdm994hg6wpcghypf50db";
    };
