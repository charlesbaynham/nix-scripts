...
rec {
  ...
  misoc = python3Packages.buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      owner = "m-labs";
      repo = "misoc";
      rev = "4191a1ae725665cee323b7bbfc60d806f9d458f8";
      sha256 = "1qw30whj7i6rf8ah67ka4f8r5zk7fc7g80p7661gwjx9g30dnp3p";
  ...
  migen = python3Packages.buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      owner = "m-labs";
      repo = "migen";
      rev = "5b5e4fdee19c4059b61371c6b70ae927980c24ad";
      sha256 = "1wmrsv6dpc0sfyryjkx4c9lx3sddw28d8k41kwm6r4ddx72lyzjx";
    };
