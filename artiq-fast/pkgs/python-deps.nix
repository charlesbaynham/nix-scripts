...
rec {
  ...
  misoc = python3Packages.buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "18ma1gj6ry6px7w9gvn4qx6kl3fki6rad72qnlr1nmh69jyj1qrm";
  ...
  migen = python3Packages.buildPythonPackage rec {
    ...
    src = fetchFromGitHub {
      owner = "m-labs";
      repo = "migen";
      rev = "19d5eae29b9ff57ea11540252f79ad1a9526ff3a";
      sha256 = "00p6k9y4ff1n8q1zmxjj42apnxzfszrq213asla7552sx4g54b9c";
    };
